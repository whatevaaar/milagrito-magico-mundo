...
const Index = () => {
    ...
    top-10 sm:top-10 md:top-14 lg:top-16">

                            <h1 className="text-xl sm:text-3xl md:text-5xl lg:text-5xl font-titan text-yellow-400
      drop-shadow-[0_0_30px_rgba(255,215,0,0.9)]
      [text-shadow:_2px_2px_0_#000,_-2px_-2px_0_#000,_2px_-2px_0_#000,_-2px_2px_0_#000]
      px-3 sm:px-6 py-1 sm:py-2 md:py-3">
                                EL MUNDO DE PATITO
                            </h1>

                            <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-titan text-yellow-400
      drop-shadow-[0_0_30px_rgba(255,215,0,0.9)]
      [text-shadow:_2px_2px_0_#000,_-2px_-2px_0_#000,_2px_-2px_0_#000,_-2px_2px_0_#000]
      px-3 sm:px-6 py-0 sm:py-1 md:py-2 mt-0">
                                MILAGRO
                            </h2>
                                    ...
                                    {(() => {
                                        ...
                                        return buttons.map((btn, i) => {
                                            ...
                                            return (<div
                                                ...
                                                >
                                                <div className="rounded-full p-0.5 sm:p-1 bg-white shadow-xl border border-yellow-300 overflow-hidden">
