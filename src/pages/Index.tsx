...
const Index = () => {
    ...
    return (<div className="min-h-screen bg-gradient-to-b from-accent via-background to-muted">
        <MusicPlayer/>
    ...
    top-2 sm:top-4 md:top-6 lg:top-8 xl:top-10">
      ...
      px-3 sm:px-6 py-0 leading-tight">
                    ...
                    {/* Wrapper CENTRAL para pato + menú */}
                    <div
                        className="
    relative
    flex
  ...
  "
                    >
                        ...
                        {/* Menú circular (ÚNICO, centrado con el pato) */}
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-30">
                            <div
                                className="
      relative
      aspect-square
      w-[130vw] sm:w-[90vw] md:w-[70vw] lg:w-[55vw]
      max-w-[750px]
      pointer-events-auto
    "
                            >
                                {(() => {
                                    const buttons = [{
                                        icon: Camera, label: "Fotos", section: "fotos"
                                    }, {
                                        icon: Sparkles, label: "Nosotros", section: "sobre-nosotros"
                                    }, {icon: Theater, label: "Obra", section: "obra"}, {
                                        icon: Star, label: "Valores", section: "valores"
                                    }, {icon: Mail, label: "Contacto", section: "contacto"}, {
                                        icon: Calendar, label: "Funciones", section: "funciones"
                                    }, {icon: Target, label: "Misión", section: "mision"}, {
                                        icon: ShoppingBag, label: "Tienda", section: "tienda"
                                    }, {icon: Heart, label: "Donaciones", section: "donaciones"}, {
                                        icon: Gamepad2, label: "Sorpresas", section: "sorpresas"
                                    }, {icon: Video, label: "Videos", section: "videos"}];

                                    const total = buttons.length;
                                    const radius = 42; // un poco más apretado para centrar mejor
                                    ...
                                    return buttons.map((btn, i) => {
                                        ...
                                        >
                                            <div
                                                className="rounded-full p-0.5 sm:p-1 bg-white shadow-xl border border-yellow-300 overflow-hidden">
                        ...
                        {/* Menú circular */}
                        <div
                            className="absolute inset-0 flex items-center justify-center pointer-events-none z-30"></div>
                    ...
                    <div
                        className="absolute bottom-[2%] sm:bottom-[0%] left-[2%] sm:left-[-0.5%] z-40 animate-float"
                        ...
                        <p className="text-[0.65rem] sm:text-xs md:text-sm font-baloo font-bold text-yellow-400 px-2 sm:px-4 py-1 sm:py-2 inline-flex items-center gap-1 sm:gap-2 [text-shadow:_0_0_20px_rgba(253,224,71,1),_0_0_40px_rgba(234,179,8,0.8),_0_0_60px_rgba(234,179,8,0.6),_2px_2px_0_#000,_-2px_-2px_0_#000,_2px_-2px_0_#000,_-2px_2px_0_#000] drop-shadow-[0_0_30px_rgba(253,224,71,1)]">
                            ...
                            <Sparkles
                                className="w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4 inline-block text-orange-400 fill-orange-400 drop-shadow-[0_0_10px_rgba(251,146,60,1)]"/>
                            <span className="text-xs sm:text-sm md:text-base">🦆</span>
                            <Heart
                                className="w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4 inline-block text-red-500 fill-red-500 drop-shadow-[0_0_10px_rgba(239,68,68,1)]"/>
                        </p>
                    </div>
        ...
        {/* Sections */}
        <div
            className="container mx-auto px-3 sm:px-4 py-8 sm:py-12 md:py-20 space-y-12 sm:space-y-16 md:space-y-24">
            ...
            <section id="obra" className="scroll-mt-20">
                <SectionCard title="🎭 La Obra de Teatro"
                             description="¡Una historia mágica que no te puedes perder!">
                    <div className="space-y-6">
                        <div
                            className="bg-gradient-to-r from-primary/20 to-accent/20 p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-primary/30">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-3 sm:mb-4">✨
                                Las Memorias de un Representante Médico ✨</h3>
                            <p className="text-base sm:text-lg md:text-xl text-foreground leading-relaxed">
                                Se trata de un rinconcito donde Patito Milagro decidió emprender su viaje artístico
                                para actuar en una obra de teatro donde Patito Milagro juega el papel de un patito
                                que se recupera de una fuerte gripita y va su dueño Alets por él con la veterinaria
                                que lo curó. Su dueño Alets va por él muy contento y feliz para volverlo a cuidar
                                con muchísimo amor y cariño. Esta obra donde participa Patito Milagro se llama Las
                                Memorias de un Representante Médico.
                            </p>
                            <p className="text-base sm:text-lg md:text-xl text-foreground leading-relaxed mt-3 sm:mt-4">
                                Se trata de una obra cómica, interactiva y musical que no olvidarás jamás, llena de
                                sonrisas, regalos y rifas sorpresas. ¡Una experiencia maravillosa! 🌟
                            </p>
                        </div>
                        <Button
                            size="lg"
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        >
                            <div
                                ...
                                <Button
                                    className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-full px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-lg w-full sm:w-auto">
                                    Reservar 🎟️
                                </Button>
                            </div>
                        </div>))}
            ...
            <section id="tienda" className="scroll-mt-20">
                <SectionCard title="🛍️ Tienda del Patito Milagro"
                             description="¡Llévate un pedacito de magia a casa!">
                ...
                <SectionCard title="💛 Apoya al Patito Milagro" description="Tu ayuda hace la diferencia">
                    <div className="space-y-6 sm:space-y-8">
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-foreground text-center leading-relaxed px-2 sm:px-4">
                            Patito Milagro tiene un gran sueño en donde tú eres el protagonista principal, ya que a
                            través de tu donativo, podrá cumplir que su gran sueño, se vuelva realidad, ya que
                            Patito Milagro quiere conseguir un espacio, para construir un hermoso albergue que se
                            llamará <strong className="text-yellow-400">EL MUNDO DE PATITO MILAGRO</strong>, donde
                            construirá un hermoso albergue donde todos los patitos que no tienen un hogar digno o un
                            lugar donde vivir, puedan vivir, de una manera feliz y maravillosa, para que el ser pato
                            se convierta en una verdadera experiencia de amor y ternura para los patitos que decidan
                            vivir aquí, es por ello que gracias a tu donativo, el gran sueño de Patito Milagro, se
                            convertirá en un verdadero MILAGRO de amor, ternura y esperanza para los patitos, si te
                            gustaría ayudar a que Patito Milagro llegue a su meta de cumplir su gran sueño, te
                            compartimos su número de cuenta de Patito Milagro para que Patito Milagro pueda llegar a
                            su meta lo antes posible, de cumplirse su sueño, te invitará a que asistas y cortes el
                            listón de la apertura del albergue: <strong className="text-yellow-400">EL MUNDO DE
                            PATITO MILAGRO</strong>, ¿te animas?, ¡mil gracias!! por tu DONATIVO. 🦆💫💛
                        </p>

                        {/* Contenedor principal con fondo de bosque */}
                        <div
                            className="relative p-3 sm:p-4 md:p-6 lg:p-8 rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-yellow-400/50 overflow-hidden">
                            {/* Fondo con imagen */}
                            <div
                            ...
                            <div className="relative space-y-4 sm:space-y-6">
                                ...
                                <h3 className="text-xs sm:text-sm md:text-base lg:text-xl xl:text-2xl font-bold text-center mb-1 sm:mb-2 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 px-2">
                                    ...
                                    <span
                                        className="text-yellow-300 [text-shadow:_2px_2px_0_#1e3a8a,_-2px_-2px_0_#1e3a8a,_2px_-2px_0_#1e3a8a,_-2px_2px_0_#1e3a8a,_1px_1px_0_#1e3a8a,_-1px_-1px_0_#1e3a8a,_1px_-1px_0_#1e3a8a,_-1px_1px_0_#1e3a8a] px-1 sm:px-2">
                      Camino hacia EL MUNDO DE PATITO MILAGRO
                                ...
                                <div
                                    className="relative h-64 sm:h-72 md:h-80 lg:h-64 bg-yellow-100/50 dark:bg-yellow-900/20 rounded-xl sm:rounded-2xl border border-yellow-400/30 sm:border-2 overflow-x-auto overflow-y-hidden pb-4">
                                    ...
                                    <div className="relative h-full min-w-[900px] sm:min-w-[1000px] md:min-w-full">
                                        ...
                                        <div
                                            className="absolute top-[60%] left-4 right-4 h-1 bg-yellow-400/50 transform -translate-y-1/2"/>
                            ...
                            INICIO
                                        ...
                                        <div className="absolute left-[16%] top-1/2 transform -translate-y-1/2">
                                            <div className="flex flex-col items-center gap-1">
                                                ...
                                                <span
                                                    className="text-xs font-bold text-yellow-600 dark:text-yellow-400 tracking-wide">
                           DONACIÓN
                         </span>
                                                {/* Imagen DONATE 1 */}
                                                <div
                                                    onClick={() => setDuckProgress(1)}
                                                    className={`relative cursor-pointer transition-all hover:scale-105 ${duckProgress >= 1 ? 'opacity-70' : 'opacity-100'}`}
                                                >
                                                    <img
                                                        src={donateImage}
                                                        alt="Donate 1"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    {activeStageLight === 1 && (<>
                                                        <div
                                                            className="absolute inset-0 rounded-full bg-[rgb(102,255,102)] blur-3xl opacity-70 animate-pulse"
                                                            style={{animationDuration: '2s'}}/>
                                                        <div
                                                            className="absolute inset-0 rounded-full bg-[rgb(139,195,74)] blur-2xl opacity-50 animate-pulse"
                                                            style={{
                                                                animationDuration: '3s', animationDelay: '0.5s'
                                                            }}/>
                                                    </>)}
                                                    <img
                                                        src={patitoPaso2}
                                                        alt="Patito Milagro - Paso 1"
                                                        className={`relative w-24 h-24 object-cover rounded-full border-4 shadow-lg transition-all duration-300 animate-float ${activeStageLight === 1 ? 'border-[rgb(106,176,76)] shadow-[0_0_40px_10px_rgba(106,176,76,0.8)]' : 'border-yellow-400'}`}
                           ...
                           ETAPA 1
                                                ...
                                                <button
                                                    ...
                                                    className={`relative mt-1 transition-all duration-300 transform hover:scale-110 ${activeStageLight === 1 ? 'opacity-100' : 'opacity-70 hover:opacity-90'}`}
                                                >
                                                    <img
                                                        src={botonSeleccion}
                           ...
                           DONACIÓN
                                                ...
                                                <div
                                                    ...
                                                    className={`relative cursor-pointer transition-all hover:scale-105 ${duckProgress >= 2 ? 'opacity-70' : 'opacity-100'}`}
                                                >
                                                    <img
                                                        src={donateImage}
                                                        alt="Donate 2"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <img
                                                        ...
                                                        className={`relative w-24 h-24 object-cover rounded-full border-4 shadow-lg transition-all duration-300 animate-float ${activeStageLight === 2 ? 'border-[rgb(106,176,76)] shadow-[0_0_40px_10px_rgba(106,176,76,0.8)]' : 'border-yellow-400'}`}
                           ...
                           ETAPA 2
                                                ...
                                                <button
                                                    ...
                                                    className={`relative mt-1 transition-all duration-300 transform hover:scale-110 ${activeStageLight === 2 ? 'opacity-100' : 'opacity-70 hover:opacity-90'}`}
                                                >
                                                    <img
                                                        src={botonSeleccion}
                                                        alt="Botón de selección"
                           ...
                           DONACIÓN
                                                ...
                                                <div
                                                    ...
                                                    className={`relative cursor-pointer transition-all hover:scale-105 ${duckProgress >= 3 ? 'opacity-70' : 'opacity-100'}`}
                                                >
                                                    <img
                                                        src={donateImage}
                                                        alt="Donate 3"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <img
                                                        ...
                                                        className={`relative w-24 h-24 object-cover rounded-full border-4 shadow-lg transition-all duration-300 animate-float ${activeStageLight === 3 ? 'border-[rgb(106,176,76)] shadow-[0_0_40px_10px_rgba(106,176,76,0.8)]' : 'border-yellow-400'}`}
                           ...
                           ETAPA 3
                                                ...
                                                <button
                                                    ...
                                                    className={`relative mt-1 transition-all duration-300 transform hover:scale-110 ${activeStageLight === 3 ? 'opacity-100' : 'opacity-70 hover:opacity-90'}`}
                                                >
                                                    <img
                                                        src={botonSeleccion}
                                                        alt="Botón de selección"
                           ...
                           DONACIÓN
                                                ...
                                                <div
                                                    ...
                                                    className={`relative cursor-pointer transition-all hover:scale-105 ${duckProgress >= 4 ? 'opacity-70' : 'opacity-100'}`}
                                                >
                                                    <img
                                                        src={donateImage}
                                                        alt="Donate 4"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <img
                                                        ...
                                                        className={`relative w-24 h-24 object-cover rounded-full border-4 shadow-lg transition-all duration-300 animate-float ${activeStageLight === 4 ? 'border-[rgb(106,176,76)] shadow-[0_0_40px_10px_rgba(106,176,76,0.8)]' : 'border-yellow-400'}`}
                           ...
                           ETAPA 4
                                                ...
                                                <button
                                                    ...
                                                    className={`relative mt-1 transition-all duration-300 transform hover:scale-110 ${activeStageLight === 4 ? 'opacity-100' : 'opacity-70 hover:opacity-90'}`}
                                                >
                                                    <img
                                                        src={botonSeleccion}
                                                        alt="Botón de selección"
                           ...
                           DONACIÓN
                                                ...
                                                <div
                                                    ...
                                                    className={`relative cursor-pointer transition-all hover:scale-105 ${duckProgress >= 5 ? 'opacity-70' : 'opacity-100'}`}
                                                >
                                                    <img
                                                        src={donateImage}
                                                        alt="Donate 5"
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <img
                                                        ...
                                                        className={`relative w-24 h-24 object-cover rounded-full border-4 shadow-lg transition-all duration-300 animate-float ${activeStageLight === 5 ? 'border-[rgb(106,176,76)] shadow-[0_0_40px_10px_rgba(106,176,76,0.8)]' : 'border-yellow-400'}`}
                           ...
                           ETAPA 5
                                                ...
                                                <button
                                                    ...
                                                    className={`relative mt-1 transition-all duration-300 transform hover:scale-110 ${activeStageLight === 5 ? 'opacity-100' : 'opacity-70 hover:opacity-90'}`}
                                                >
                                                    <img
                                                        src={botonSeleccion}
                                                        alt="Botón de selección"
                                        ...
                                        <div className="absolute left-[86%] top-1/2 transform -translate-y-1/2">
                                            <div className="flex flex-col items-center gap-1">
                                                ...
                                                />
                                                <span
                                                    className="-mt-1 text-xs font-bold text-yellow-600 dark:text-yellow-400">
                             SUEÑO CUMPLIDO
                           </span>
                                                {duckProgress === 5 && (<div
                                                ...
                                                <button
                                                    ...
                                                    className={`relative mt-1 transition-all duration-300 transform hover:scale-110 ${isGoldenLightActive ? 'opacity-100' : 'opacity-70 hover:opacity-90'}`}
                                                >
                                                    {isGoldenLightActive && (<>
                                                        {/* Golden glow effect */}
                                                        <div
                                                            className="absolute inset-0 rounded-full bg-yellow-400 blur-xl opacity-70 animate-pulse"
                                                            style={{animationDuration: '1.5s'}}/>
                                                        <div
                                                            className="absolute inset-0 rounded-full bg-amber-500 blur-lg opacity-50 animate-pulse"
                                                            style={{
                                                                animationDuration: '2s', animationDelay: '0.3s'
                                                            }}/>
                                                        {/* Sparkles */}
                                                        <div
                                                            className="absolute -top-2 -left-2 text-yellow-300 animate-ping"
                                                            style={{animationDuration: '1s'}}>✨
                                                        </div>
                                                        <div
                                                            className="absolute -top-2 -right-2 text-amber-400 animate-ping"
                                                            style={{
                                                                animationDuration: '1.2s', animationDelay: '0.2s'
                                                            }}>⭐
                                                        </div>
                                                        <div
                                                            className="absolute -bottom-2 -left-2 text-yellow-400 animate-ping"
                                                            style={{
                                                                animationDuration: '1.4s', animationDelay: '0.4s'
                                                            }}>✨
                                                        </div>
                                                        <div
                                                            className="absolute -bottom-2 -right-2 text-amber-300 animate-ping"
                                                            style={{
                                                                animationDuration: '1.6s', animationDelay: '0.6s'
                                                            }}>⭐
                                                        </div>
                                                    </>)}
                                                    <img
                                ...
                                <div className="text-center">
                                    <div
                                        className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 bg-gradient-to-r from-green-700/95 via-yellow-500/95 to-green-700/95 px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl border border-yellow-400 sm:border-2 shadow-2xl">
                                        <Sparkles
                                            className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-yellow-300 animate-pulse"/>
                                ...
                                {duckProgress === 5 && (<div
                                    className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-400 p-6 rounded-2xl text-center animate-pulse">
            ...
            <section id="sobre-nosotros" className="scroll-mt-20">
                <SectionCard title="✨ Sobre Patito Milagro"
                             description="Más que una marca, un movimiento de esperanza">
                    <div className="space-y-4 sm:space-y-6">
                        <p className="text-sm sm:text-base md:text-lg text-foreground leading-relaxed">
                            Patito Milagro es un proyecto que combina creatividad, arte y compromiso social con un
                            objetivo noble:
                            generar conciencia y esperanza a través de la ternura. Nuestra empresa nace del deseo de
                            unir el mundo
                            de los productos con causa —como peluches y playeras— con el poder transformador del
                            arte escénico,
                            mediante una obra de teatro protagonizada por nuestro entrañable personaje, el patito
                            Milagro.
                        </p>
                        <p className="text-sm sm:text-base md:text-lg text-foreground leading-relaxed">
                            Más allá de ofrecer artículos de calidad y experiencias artísticas, buscamos inspirar
                            valores de
                            empatía, respeto y amor hacia los animales. Parte de los recursos obtenidos se destinan
                            a una causa
                            fundamental: la construcción de un albergue para patitos sin hogar, un espacio donde
                            puedan recibir
                        ...
                        <p className="text-sm sm:text-base md:text-lg text-foreground leading-relaxed font-semibold">
                            Patito Milagro es más que una marca; es un movimiento que invita a creer que los
                            milagros pueden
                            surgir cuando las personas se unen con un propósito común: ayudar, crear y compartir
                            esperanza.
                        </p>
                    </div>
                </SectionCard>
            ...
            <section id="mision" className="scroll-mt-20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                    <SectionCard title="🎯 Nuestra Misión">
                        <p className="text-sm sm:text-base md:text-lg text-foreground leading-relaxed">
                            La misión de Patito Milagro es demostrar que los milagros existen cuando se unen la
                            creatividad
                            y el respeto por la naturaleza y los animales. A través de nuestros productos y de la
                            magia del
                            teatro, trabajamos para transformar cada sonrisa en una acción solidaria que contribuya
                            a la
                    ...
                    <SectionCard title="🌟 Nuestra Visión">
                        <p className="text-sm sm:text-base md:text-lg text-foreground leading-relaxed">
                            La visión de Patito Milagro es que cada persona que conozca a nuestro patito —ya sea en
                            un
                            escenario, en una tienda o en un abrazo de peluche— se sienta parte de un milagro
                            colectivo:
            ...
            <section id="valores" className="scroll-mt-20">
                <SectionCard title="💎 Nuestros Valores" description="Los principios que nos guían">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        <div
                            className="bg-gradient-to-br from-primary/20 to-primary/5 p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border border-primary/30 sm:border-2 transform transition-all hover:scale-105">
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-primary mb-2 sm:mb-3">❤️
                                Amor</h3>
                            <p className="text-foreground leading-relaxed text-sm sm:text-base">
                                El motor que impulsa cada acción y cada creación en Patito Milagro. Creemos en el
                                amor como
                        ...
                        <div
                            className="bg-gradient-to-br from-secondary/20 to-secondary/5 p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border border-secondary/30 sm:border-2 transform transition-all hover:scale-105">
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-secondary mb-2 sm:mb-3">🤝
                                Empatía</h3>
                            <p className="text-foreground leading-relaxed text-sm sm:text-base">
                                Nos ponemos en el lugar de los demás —humanos y animales— para comprender sus
                                necesidades
                        ...
                        <div
                            className="bg-gradient-to-br from-accent/20 to-accent/5 p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border border-accent/30 sm:border-2 transform transition-all hover:scale-105">
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-accent mb-2 sm:mb-3">🎨
                                Creatividad</h3>
                            <p className="text-foreground leading-relaxed text-sm sm:text-base">
                                Fomentamos la imaginación como herramienta para transmitir mensajes positivos y
                                construir
                        ...
                        <div
                            ...
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-primary mb-2 sm:mb-3">🤲
                                Solidaridad</h3>
                            <p className="text-foreground leading-relaxed text-sm sm:text-base">
                                Cada producto, cada obra y cada gesto están pensados para ayudar y generar un
                                impacto
                        ...
                        <div
                            className="bg-gradient-to-br from-secondary/20 to-secondary/5 p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border border-secondary/30 sm:border-2 transform transition-all hover:scale-105">
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-secondary mb-2 sm:mb-3">🌿
                                Respeto por la vida</h3>
                            <p className="text-foreground leading-relaxed text-sm sm:text-base">
                                Promovemos el cuidado y la protección de todos los seres vivos, fomentando una
                                convivencia
                        ...
                        <div
                            ...
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-accent mb-2 sm:mb-3">✨
                                Esperanza</h3>
                            <p className="text-foreground leading-relaxed text-sm sm:text-base">
                                Creemos que cada pequeño acto de bondad puede convertirse en un milagro capaz de
                                transformar
                                el mundo.
                            </p>
                        </div>
                ...
                <SectionCard title="📧 Contáctanos" description="¡Nos encantaría saber de ti!">
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div
                                className="bg-muted p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border-2 sm:border-3 md:border-4 border-primary/20">
                                <h4 className="text-base sm:text-lg md:text-xl font-bold text-primary mb-2">📱
                                    Teléfono</h4>
                                <p className="text-sm sm:text-base md:text-lg text-foreground">5545211175</p>
                            </div>
                            <div
                                className="bg-muted p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border-2 sm:border-3 md:border-4 border-accent/20">
                                <h4 className="text-base sm:text-lg md:text-xl font-bold text-accent mb-2">✉️
                                    Email</h4>
                ...
                <SectionCard title="🎁 Zona de Sorpresas" description="¡Diversión extra para ti!">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        >
                            ...
                            <h4 className="text-base sm:text-lg md:text-xl font-bold text-primary">Dibujos para
                                Colorear</h4>
                        </div>
                        <div
                            className="bg-gradient-to-br from-accent/30 to-primary/30 p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border-2 sm:border-3 md:border-4 border-accent/20 text-center space-y-3 sm:space-y-4 transform transition-all hover:scale-105 cursor-pointer">
                        ...
                        >
                            ...
                            <h4 className="text-base sm:text-lg md:text-xl font-bold text-secondary">Juegos
                                Interactivos</h4>
                        </div>
                    </div>

                    {/* Dibujos para Colorear desplegables */}
                    {showColoring && (<div className="mt-6 sm:mt-8 animate-fade-in">
                        <div
                            className="bg-gradient-to-br from-primary/10 to-secondary/10 p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl border-2 sm:border-3 md:border-4 border-primary/30">
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-4 sm:mb-6 text-primary">🎨
                                Dibujos para Colorear</h3>
                            ...
                            <div
                                ...
                                }, {img: patito5, name: "Patito 5"}].map((duck, index) => (<div
                                    key={index}
                                ...
                                >
                                    ...
                                    <div
                                        className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-xl sm:rounded-2xl">
                                        <p className="text-white font-bold text-xs sm:text-sm px-2 text-center">Click
                                            derecho → Guardar imagen</p>
                                    </div>
                                </div>))}
                            </div>
                        </div>
                    ...
                    {/* Juegos desplegables */}
                    {showGames && (<div className="mt-8 animate-fade-in">
                        <div
                            className="bg-gradient-to-br from-primary/10 to-accent/10 p-6 rounded-3xl border-4 border-primary/30">
                            <h3 className="text-3xl font-bold text-center mb-6 text-primary">🎮 Juegos
                                Interactivos</h3>
                            <div className="space-y-6">
